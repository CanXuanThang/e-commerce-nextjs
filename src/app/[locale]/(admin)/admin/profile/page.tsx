      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="grid gap-5 md:grid-cols-2">
          <div className="rounded-3xl bg-slate-50 p-5">
            ...
            <p className="mt-2 text-lg font-semibold text-slate-900">Admin User</p>
          </div>
          <div className="rounded-3xl bg-slate-50 p-5">
          ...
          <div className="rounded-3xl bg-slate-50 p-5">
            ...
            <p className="mt-2 text-lg font-semibold text-slate-900">Super Admin</p>
          </div>
          <div className="rounded-3xl bg-slate-50 p-5">
            <p className="text-xs uppercase tracking-[0.18em] text-slate-400">Phone</p>
            <p className="mt-2 text-lg font-semibold text-slate-900">0901234567</p>
          </div>
        </div>
      </div>
    </div>
